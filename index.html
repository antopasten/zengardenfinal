...
<body>
  ...
  <h2> The beauty of CSS design </h2>
   ...
   <h5>
     VIEW THIS DESIGN CSS / CSS RESOURCES / FAQ / SUBMIT A DESIGN  TRANSLATIONS
  </h5>
<br/> <br/><br/> <br/>
  

      <div id="lateral">
        <h4> THE ROAD TO ENLIGHTENMENT </h4>
...
The CSS Zen Garden invites you to relax and meditate on the important lessons of the masters. Begin to see with clarity. Learn to use the time-honored techniques in new and invigorating fashion. Become one with the web. </p> </div>
    
      <div id="principal">
        <h4> SO WHAT IS THIS ABOUT? </h4>
  <p> There is a continuing need to show the power of CSS. The Zen Garden aims to excite, inspire, and encourage participation. To begin, view some of the existing designs in the list. Clicking on any one will load the style sheet into this very page. The HTML remains the same, the only thing that has changed is the external CSS  le. Yes, really.
...
VERDE MODERNA <br/>
  ...
  <div class="nombre">
<h5>By Antonella Pastén Bernales. Bandwidth graciously donated by mediatemple. Now available: Zen Garden, the book.</h5> 
  </div>
</body>
